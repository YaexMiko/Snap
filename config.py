...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002405718774"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002360923648"))
...
USER_REPLY_TEXT = os.environ.get("USER_REPLY_TEXT", "❌ 𝙿𝚕𝚎𝚊𝚜𝚎 𝙰𝚟𝚘𝚒𝚍 𝙳𝚒𝚛𝚎𝚌𝚝 𝙼𝚎𝚜𝚜𝚊𝚐𝚎𝚜.")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002574894627"))
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "6010797751"))
#port set to default 8080
PORT = os.environ.get("PORT", "6226")
...
#your database name
DB_NAME = os.environ.get("DB_NAME", "Snap")
...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "852a22502bb47a9388ad4daf9f8425c845f4eba1")
...
TUT_VID = os.environ.get("TUT_VID","http")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7749734225 7350721166 6616938712").split()):
        ADMINS.append(int(x))
except ValueError:
